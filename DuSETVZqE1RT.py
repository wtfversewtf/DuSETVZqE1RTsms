...
import requests, time, re, json, uuid, random, sys, signal
...
\x1b[38;5;230m██║     ██║███████╗██║      ███████║██║ ╚═╝ ██║███████║
\x1b[38;5;230m╚═╝     ╚═╝╚══════╝╚═╝      ╚══════╝╚═╝     ╚═╝╚══════╝
\x1b[38;5;230m   Author: R!SK | SMS Spam (V1.0)

\033[1;37m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;32m Telegram : https://t.me/eccedentesiastmf
\033[1;31m [+] USDT TRC20: TVcYHPzMnrbrshf2ZdvCzcdpvwLRSvPiPH
...
\033[1;37m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
run_banner(banner, delay=0.0001)

amount = 5000
print(f"\x1b[38;5;226m[ DATE ] : \x1b[38;5;46m{ngay_hom_nay}/{thang_nay}/{nam_}\n")
sdt = input("\033[1;31m[ + ] Enter Phone Number: ")
...
while True:
    try:
        ...
        print("Error: The count must be an integer. Please enter it again.")
...
def run(sdt,i):                  
  ...
  threading.submit(KILO,sdt)
  threading.submit(GAPO,sdt) 
  print("\x1b[38;5;46m[ \x1b[38;5;226mFILI\x1b[38;5;46m ] Send SMS - Call | Delay : 5 | Status : Successful \033[1;37m",)  
  for j in range(0, 5):
    # code trong vòng lặp
    print(f"\x1b[38;5;46m[ \x1b[38;5;226mFILI\x1b[38;5;46m ] | LOADING... \033[1;37m\r",end="")
